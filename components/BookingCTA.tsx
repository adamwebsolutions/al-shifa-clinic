  ...
  return (
    <section className="py-20" style={{ backgroundColor: "#1B3A6B" }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-blue-200 text-lg max-w-xl mx-auto mb-6 leading-relaxed">
        ...
        <p className="text-blue-200 text-sm mb-8 opacity-80">
          Trusted by 5,000+ patients in DHA Lahore · 5.0★ Google Reviews · Reply within minutes
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-white hover:bg-blue-50 font-bold py-4 px-8 rounded-xl text-base transition-all shadow-lg min-h-[48px]"
            style={{ color: "#1B3A6B" }}
          >
            📅 Book via Cal.com
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 bg-green-700 hover:bg-green-800 text-white font-bold py-4 px-8 rounded-xl text-base transition-all shadow-lg min-h-[48px]"
          >
