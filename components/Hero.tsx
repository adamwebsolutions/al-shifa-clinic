          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-10">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold px-6 py-3.5 rounded-xl text-base transition-all shadow-lg hover:shadow-xl"
              >
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
              ...
              <div className="p-5">
                ...
                <div className="text-sm text-gray-500 mb-3">MBBS, FCPS — General Practice & Family Medicine</div>
                <div className="flex gap-1 mb-3">
                  ...
                  <span className="text-xs text-gray-500 ml-1">5.0 Google Reviews</span>
                </div>
