      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            {/* Micro social proof */}
            <p className="text-blue-700 text-xs font-semibold mb-4">
              ✓ Trusted by 5,000+ patients · 5.0★ Google Reviews · Same-day slots available
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-10">
              <a
                ...
                className="flex items-center justify-center gap-2 text-white font-semibold px-6 py-3.5 rounded-xl text-base transition-all shadow-lg hover:shadow-xl min-h-[48px]"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 bg-green-700 hover:bg-green-800 text-white font-semibold px-6 py-3.5 rounded-xl text-base transition-all shadow-lg hover:shadow-xl min-h-[48px]"
              >
